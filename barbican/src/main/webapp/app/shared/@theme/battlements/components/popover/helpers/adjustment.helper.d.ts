...
export declare class NbAdjustmentHelper {
     ...
     * */
    static adjust(placed: ClientRect, host: ClientRect, placement: NbPopoverPlacement, adjustment: NbPopoverAdjustment): NbPopoverPosition;
    /**
     ...
     * @return {NbPopoverPosition} calculated position.
     * */
    private static chooseBest(placed, possible);
    /**
     ...
     * */
    private static inViewPort(placed, position);
    /**
     ...
     * ```
     * */
    private static orderPlacements(placement, placements);
}
